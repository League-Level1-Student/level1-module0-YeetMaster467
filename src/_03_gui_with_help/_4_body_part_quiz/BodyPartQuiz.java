...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if(guess.equalsIgnoreCase("Arnold Schwarznegger")) {
			...
			JOptionPane.showMessageDialog(null, "Nope, it was Arnold Schwarznegger.");
		}
		// 6. Otherwise:
		...
		if(guess.equalsIgnoreCase("Leonardo DiCaprio")) {
			...
			JOptionPane.showMessageDialog(null, "Nope, it was Leonardo DiCaprio.");
		}
		showNextImage();
		...
		if(guess.equalsIgnoreCase("Morgan Freeman")) {
			...
			JOptionPane.showMessageDialog(null, "Nope, it was Morgan Freeman.");
		}
		showNextImage();
		...
		if(guess.equalsIgnoreCase("Jack Black")) {
			...
			JOptionPane.showMessageDialog(null, "Nope, it was Jack Black.");
		}
		
		// 9. Show them their current score
		JOptionPane.showMessageDialog(null, "You got " + score + " out of 4 images correct.");
