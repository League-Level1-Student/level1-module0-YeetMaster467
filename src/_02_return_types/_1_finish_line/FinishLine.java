...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		if(finished) {
			JOptionPane.showMessageDialog(null, "You finished! You traveled " + distance + " pixels!");
		}else {
			JOptionPane.showMessageDialog(null, "You did not finish. You traveled " + distance + " pixels.");
		}
